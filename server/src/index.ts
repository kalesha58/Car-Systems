...
import userServiceBookingRoutes from './routes/user/serviceBookingRoutes';
...
app.use('/api/user/service-bookings', userServiceBookingRoutes);
logger.info('[Routes] User service booking routes mounted at /api/user/service-bookings');
