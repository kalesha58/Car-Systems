...
const light = {
  ...
  header: brand.neutral.white,
  headerForeground: brand.neutral.jetBlack,
  statusBarStyle: 'dark-content' as const,
  statusBarBackground: brand.neutral.white,
...
const dark = {
  ...
  header: brand.neutral.jetBlack,
  headerForeground: brand.neutral.white,
  statusBarStyle: 'light-content' as const,
  statusBarBackground: brand.neutral.jetBlack,
  aiGradientStart: brand.red.gradientStart,
