...
type PreBookingRouteParams = {
  PreBooking: {
    vehicleId: string;
  };
};

const PreBookingScreen: React.FC = () => {
  const route = useRoute<RouteProp<PreBookingRouteParams, 'PreBooking'>>();
    ...
    const loadVehicle = async () => {
      try {
        ...
        if (response.success && response.Response) {
          ...
          if (vehicleData && vehicleData.availability !== 'available') {
  ...
  if (loading) {
    return (
      <View style={styles.container}>
        <CustomHeader title="Pre-Book Vehicle" />
    ...
    <KeyboardAvoidingView
      ...
      <ScrollView
        ...
        <View style={styles.infoCard}>
          <Icon name="information-circle-outline" size={RFValue(24)} color={colors.secondary} style={styles.infoIcon} />
          <CustomText style={styles.infoText}>
            Pre-booking reserves this vehicle for you. The dealer will confirm your booking and you can complete the purchase on the selected date.
          </CustomText>
        </View>
        ...
        <View style={styles.section}>
          <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 12 }}>
            ...
            <CustomText variant="h4" fontFamily={Fonts.SemiBold}>Select Booking Date</CustomText>
          </View>
          <TouchableOpacity
        ...
        <View style={styles.submitButton}>
          <CustomButton
            title={submitting ? 'Submitting...' : 'Pre-Book Vehicle'}
